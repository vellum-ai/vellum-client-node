...
export const AdHocExpandMetaRequest: core.serialization.ObjectSchema<
    serializers.AdHocExpandMetaRequest.Raw,
    Vellum.AdHocExpandMetaRequest
...
export declare namespace AdHocExpandMetaRequest {
    interface Raw {
        cost?: boolean | null;
