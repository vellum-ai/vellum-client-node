...
export const GenerateBodyRequest: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    requests: core.serialization.list(core.serialization.lazyObject(async () => (await import("..")).GenerateRequest)),
