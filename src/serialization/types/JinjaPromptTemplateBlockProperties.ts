...
export const JinjaPromptTemplateBlockProperties: core.serialization.ObjectSchema<
    serializers.JinjaPromptTemplateBlockProperties.Raw,
    Vellum.JinjaPromptTemplateBlockProperties
