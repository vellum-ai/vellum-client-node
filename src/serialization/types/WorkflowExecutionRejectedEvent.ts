...
import { WorkflowExecutionRejectedBody } from "./WorkflowExecutionRejectedBody";
import { ApiVersionEnum } from "./ApiVersionEnum";

export const WorkflowExecutionRejectedEvent: core.serialization.ObjectSchema<
    serializers.WorkflowExecutionRejectedEvent.Raw,
...
export declare namespace WorkflowExecutionRejectedEvent {
