...
export const StringParameterConfigRequest: core.serialization.ObjectSchema<
    serializers.StringParameterConfigRequest.Raw,
    Vellum.StringParameterConfigRequest
