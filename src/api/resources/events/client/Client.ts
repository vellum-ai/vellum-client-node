...
export class Events {
     ...
     *     })
     */
    public monitoringV1EventsCreate(
        request: Vellum.WorkflowEvent,
        requestOptions?: Events.RequestOptions,
    ): core.HttpResponsePromise<Vellum.EventCreateResponse> {
        return core.HttpResponsePromise.fromPromise(this.__monitoringV1EventsCreate(request, requestOptions));
    }

    private async __monitoringV1EventsCreate(
        request: Vellum.WorkflowEvent,
        requestOptions?: Events.RequestOptions,
