...
<details><summary><code>client.prompts.<a href="/src/api/resources/prompts/client/Client.ts">pullPrompt</a>(id, { ...params }) -> Vellum.PromptExecConfig</code></summary>
<dl>
<dd>
...
```typescript
await client.prompts.pullPrompt("id");
```
...
**request:** `Vellum.PullPromptRequest`
